...
$(document).ready(function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $('#new_arrival_item').html(Products);
            $('#new_arrival_item').SumoSelect({ search: true, searchText: 'Enter here.' });
        },
        error: function (xhr) {
	...
	<div class="card shadow mb-4">
        <div class="card-header">
            ...
            <div class="row">
                <form id="add_new_arrival_product" enctype="multipart/form-data">
                  @csrf
                            <div class="col-md-6">
                        <div class="form-group ">
                            <select id="new_arrival_item" name="new_arrival_item" class="form-control">
...
new_arrival_product_table();
                ...
                <tbody id="new_arrival_product_table">
