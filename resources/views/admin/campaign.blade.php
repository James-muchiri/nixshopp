	...
	<div class="card shadow mb-4">
        <div class="card-header">
            ...
            <div class="row">
                  ...
                  <form id="admin_campaign" enctype="multipart/form-data" >
                    @csrf
                              <div class="col-md-6">
                          <div class="form-group ">
                              <select id="best_product_item" name="camp_id" class="form-control">
