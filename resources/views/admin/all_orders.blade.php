        ...
        <form action="/admin/orders" method="GET">
          <div class="row mb-4 justify-content-center">
            ...
            <div class="col-lg-12 text-center mt-3">
                ...
                <a href="/admin/orders" class="btn btn-info py-1">Reset</a>
            </div>
        </div>
        </form>
      ...
      <td>
          <div class="dropdown">
              ...
              <div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
                ...
                <a class="dropdown-item" data-toggle="modal" data-target="#statusModal" href="javascript:;" data-href="/admin/order/status/113/order_status/Progress">In Progress</a>
