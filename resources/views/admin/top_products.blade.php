...
$(document).ready(function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $('#top_product_item').html(Products);
            $('#top_product_item').SumoSelect({ search: true, searchText: 'Enter here.' });
        },
        error: function (xhr) {
	...
	<div class="card shadow mb-4">
        <div class="card-header">
            ...
            <div class="row">
                <form id="add_top_product" enctype="multipart/form-data">
                  @csrf
                            <div class="col-md-6">
                        <div class="form-group ">
                            <select id="top_product_item" name="top_product_item" class="form-control">
